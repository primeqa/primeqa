...
class TestSQUADPostProcessor(UnitTest):
    ...
    @pytest.fixture(scope='session')
    def extractive_postprocessor_output(self):
        predictions ={
    ...
    def test_post_processor_has_examples_and_features(self, squad_eval_examples_and_features, extractive_postprocessor_output):
        eval_examples, _ = squad_eval_examples_and_features
        predictions = extractive_postprocessor_output
        ...
        processed_predictions = postprocessor.prepare_predictions_for_squad(eval_examples, predictions)
