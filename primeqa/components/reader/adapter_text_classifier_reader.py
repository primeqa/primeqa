...
@dataclass
class AdapterTextClassifierReader(BaseReader):
    # TODO update summary
    """_summary_
...
# There is no AdapterBooleanQTCReader or AdapterEVCReader to parallel 
# the BooleanQTCReader or BooleanEVCReader in text_classifier_reader.py
# because the AdapterTextClassifierReader cannot be initialized for stand-alone :
# it requires an MRC model (provided by AdapterExtractiveWithBooleanReader) to
# insert adapters in to.