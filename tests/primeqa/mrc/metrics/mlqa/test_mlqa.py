...
class TestMLQA(UnitTest):
    ...
    def references_and_predictions(self):
        references = [
            dict(id='13f8eea6654690750d6c7ed262aa7345a92738c2', answers=dict(text=['宪法保障宗教自由'], answer_start=[18]), answer_language='zh'),
            dict(id='2c4f008cd63348244e4553d1c529665ad18f5a4a', answers=dict(text=['伊斯兰教'], answer_start=[32]), answer_language='zh'),
            dict(id='b08184972e38a79c47d01614aa08505bb3c9b680', answers=dict(text=['十支'], answer_start=[153]), answer_language='zh'), 
            dict(id='36e2d9a94f3e08427a85e202229e50350abc80e1', answers=dict(text=['《毁灭战士3》'], answer_start=[0]), answer_language='zh'),
            dict(id='faf513d17057c6bb95175c670ec98061b5cb2fce', answers=dict(text=['BFG 9000和电锯'], answer_start=[197]), answer_language='zh'), 
            dict(id='b3fa3ec7514fab23baa7b630814e670a1418ee40', answers=dict(text=['《毁灭战士3》'], answer_start=[342]), answer_language='zh'), 
            dict(id='a7888e1802b7ed59e0d6e4b6ff4348595f5d1f74', answers=dict(text=['赫尔辛基'], answer_start=[88]), answer_language='zh'), 
            dict(id='9835becbfb3914e25253151e3c43fe0bfa2fecc4', answers=dict(text=['1993'], answer_start=[0]), answer_language='zh'), 
            dict(id='040b6b9d4ceb3cc4f0981e59aabc47227232e371', answers=dict(text=['压力、经济环境，网路上的娱乐和资讯'], answer_start=[294]), answer_language='zh'), 
            dict(id='9e9a108fdf106838bceeb3b4d9693e39931df705', answers=dict(text=['蚁酸'], answer_start=[51]), answer_language='zh') 
        ]
        predictions = [
