...
from oneqa.ir.dense.colbert.colbert import print_message, load_checkpoint, remove_first_and_last_quote
from oneqa.ir.dense.colbert.colbert import load_model
