...
def main():
    ...
    if training_args.do_eval:
        eval_dataset = get_datasets(data_args.eval_dataset, cache_dir=model_args.cache_dir)
        eval_dataset = expand_answers(eval_dataset, separate_answers=False)
        # Validation Feature Creation
        with training_args.main_process_first(desc="validation dataset map pre-processing"):
            eval_examples, eval_dataset = preprocessor.process_eval(eval_dataset)
