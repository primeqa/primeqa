...
class ModelForORQATasks(PreTrainedModel):
    """
    ...
    def __init__(self,
        ...
        if type(self) is ModelForORQATasks:
            raise TypeError(f"{ModelForORQATasks.__class__.__name__} is not intended to be directly "
