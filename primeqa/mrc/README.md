...
### Table QA
PrimeQA also supports answering questions over tables using TAPAS or TAPEX. Please check out the documentation on how to run [PrimeQA/Tapas](https://github.com/primeqa/primeqa/tree/tapas_v2/primeqa/tableqa/tapas) and [PrimeQA/Tapex](https://github.com/primeqa/primeqa/tree/tapas_v2/primeqa/tableqa/tapex) for more information.
