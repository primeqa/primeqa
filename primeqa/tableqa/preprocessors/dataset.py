...
class DatasetProcessor(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        print("answer_coordinates",item.answer_coordinates)
        
        if str(item.answer_coordinates)!="nan":
            answer_coordinates=ast.literal_eval(str(item.answer_coordinates))
            print("answer_coordinates",answer_coordinates)
            #answer_coordinates = [ast.literal_eval(x) for x in answer_coordinates]
