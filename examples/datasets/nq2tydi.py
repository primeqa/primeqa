...
class NQ2Tydi:
    """
    Class to process the full NQ dataset and get in tydi format
    ...
    def process(self, input_file, output_file, num_lines=-1, verbose=False):
        ...
        for file in files:
            ...
            with gzip.open(output_file,'ab') as writer:
...
def main():
    ...
    parser = HfArgumentParser(NQ2TyDiArguments)
    ...
    converter = NQ2Tydi()
    converter.process(args.input_file, args.output_file, args.num_lines, args.verbose)
