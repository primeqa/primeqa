...
class Arguments():
    ...
    def add_model_training_parameters(self):
        ...
        self.add_argument('--model_type', dest='model_type', default='bert', choices=['bert','xlm-roberta', 'roberta'], required=False)
        ...
        self.add_argument('--teacher_model_type', dest='teacher_model_type', choices=['bert', 'roberta','xlm-roberta'], default='bert', required=False )
