...
@dataclass
class AdapterExtractiveWithBooleanReader(BaseReader):
    """_summary_
    ...
    def predict(
        ...
        **kwargs,
        ...
        for example_id, evc_raw_prediction in evc_prediction_output.predictions.items():
            if example_id not in per_query_predictions:
                per_query_predictions[example_id]={}
            per_query_predictions[example_id]['boolean_answer_pred']=evc_raw_prediction[0]['boolean_answer_pred']
            per_query_predictions[example_id]['boolean_answer_scores']=evc_raw_prediction[0]['boolean_answer_scores']
