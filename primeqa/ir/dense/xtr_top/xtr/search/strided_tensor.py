...
from primeqa.ir.dense.xtr_top.xtr.indexing.utils import flatten
from primeqa.ir.dense.xtr_top.xtr.search.strided_tensor_core import StridedTensorCore, _create_mask, _create_view
