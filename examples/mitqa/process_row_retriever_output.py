...
def create_dataset_for_answer_extractor(data,output_file_path, test=False):
    #print(len(data))
    label_1_data = []
    prev_qid = ""
    i=1
    ...
    json.dump(label_1_data,open(output_file_path,"w"), indent=4)
...
def preprocess_data_using_row_retrieval_scores(data_path,test,row_ret_pred_path):
